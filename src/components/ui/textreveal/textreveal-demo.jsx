...
import TextRevealByWord from "./textreveal"; // Update this path according to your folder structure

const TextRevealDemo = () => {
  return (
    <div className="z-10 flex flex-row  ml-[5%] h-auto w-[80%] items-centre justify-centre rounded-lg mt-[5%]">
